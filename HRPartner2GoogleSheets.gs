/*====================================================================================================================================*
  HRPartner2GoogleSheets by Devan Sabaratnam at HR Partner
  ====================================================================================================================================
  Version:      1.0.0
  Project Page: https://github.com/HR-Partner/HRPartner2GoogleSheets
  Copyright:    (c) 2020 by Devan Sabaratnam
  License:      GNU General Public License, version 3 (GPL-3.0) 
                http://www.opensource.org/licenses/gpl-3.0.html
  ------------------------------------------------------------------------------------------------------------------------------------
  A library for importing HR Partner data into Google Sheets via the HR Partner API.
  
  Based on the excellent ImportJSON library by Brad Jasper and Trevor Lohrbeer.  For more information on their work, visit:
  https://github.com/bradjasper/ImportJSON
  
  Functions include:

     ImportHRPartner       For use by end users to import data from an HR Partner module into a Sheet 
     DateHRPartner         For use by end users to convert HR Partner date/time strings to Google Sheet date objects

  For technical documentation on our API, see https://developer.hrpartner.io
  
  For bug reports see https://github.com/HR-Partner/HRPartner2GoogleSheets/issues
...
// Don't change this!
const hrPartnerUrl = 'https://api.hrpartner.io/';

/**
 * Insert your own HR Partner company key below. See
 * https://help.hrpartner.io/article/80-about-our-api 
 * for instructions on getting your key.
 **/
const hrPartnerApiKey = '<insert your HR Partner API key here>';
 ...
 * For example:
 *
 *   =ImportHRPartner("absences?employee=JONES", "/absence_type,/description,/absence_date,/employee/full_name",
 *               "noInherit,noTruncate,rawHeaders")
 * 
 * @param {object}       the HR Partner data object name (e.g. employees, reminders, training etc.)
 * @param {fields}       a comma-separated list of fields/paths to import. Any path starting with one of these paths gets imported.
...
function ImportHRPartner(object, fields, parseOptions) {
  var header = { headers: { "x-api-key": hrPartnerApiKey } };
  return ImportJSONAdvanced(hrPartnerUrl + object, header, fields, parseOptions, includeXPath_, defaultTransform_);
};


/**
 * Converts a returned date or datetime string from HR Partner into a proper Date() object in Google Sheets.
 *
 * The passed datestring variable must be in the format:
 *    yyyy-mm-dd, or
 *    yyyy-mm-ddThh:nn:ss
 *
 * where:
 ...
 *    ss - 2 digit seconds
 *
 * All 2 digit numbers above have to have a leading 0, i.e. '1' should be represented as '01', whereas '12' can be '12'.
 *
 * @param {datestring}    The date or date/time string returned from a call to HR Partner
 * @customfunction
 *
 * @return a javascript Date() object that can be used in Date/Time calculations in Google Sheets
 **/
